---
title: "Development of Machine Learning Models on Hazmat Incidences"
date: "April 24, 2016"
output: html_document
---

```{r, echo=F, comment=FALSE}
library(dplyr)
library(caret)
library(stringr)
```
...
forest_RMSE <- RMSE(test_set$number_of_hazardous_incidents, forest_predict)
    qplot(forest_predict, test_set$number_of_hazardous_incidents,
          xlab = "Predicted Values", ylab = "Actual Number of Accidents") + geom_abline() +
